      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              children: [
                inputForm("ราคารถ", _controller1, "600000"),
                inputForm("เงินดาวน์", _controller2, "100000"),
                inputForm("จำนวนปีที่ผ่อน", _controller3, " 4"),
                inputForm("ดอกเบี้ย % ต่อปี", _controller4, " 1.59"),
              ],
            ),
          ),
          SizedBox(
